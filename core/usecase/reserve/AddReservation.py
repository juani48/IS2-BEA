...
def usecase_add_reserve(start_day, end_day, client_id, machine_id, shipment):
    ...
    reserve = ReservationModel(start_day=start_day, client_id=client_id, machine_id=machine_id, end_day=end_day, total_value=total_value, shipment=shipment,preference_id=preference.get("id"))
